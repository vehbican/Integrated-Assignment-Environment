...
public class ProcessManager {
    ...
    public void CompileFile(Configuration configuration,String submissionDirectory) throws IOException, InterruptedException {
        ...
        String path = configuration.getMainFileName();
        configuration.getCompilerParameters().add(path);
    ...
    public void RunExecutable(List<String> args,String submissionDirectory) throws IOException, InterruptedException {
    ...
    public void CompileFile2(Configuration configuration,String submissionDirectory) throws IOException, InterruptedException {
